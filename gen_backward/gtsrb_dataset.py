...
class GTSRBDataset:
    ...
    def load_imgs(self):
        ...
        self.train_poisoned_img_index=[]
        self.train_clean_img_index=[]
...
def apply_poison(img, poison_img, poison_loc):
    ...
    if poison_loc == 'TL':
        ...
        start_index=(32-poison_size,0)
        end_index=(32,poison_size)
    elif poison_loc=='TR':
        start_index=(0,32-poison_size)
        end_index=(poison_size,32)
...
def gen_poison(poison_type, poison_size):
    ...
    """
    if poison_type == 'FF':
        poison_img = Image.open('poison_imgs/FF.png').resize((poison_size, poison_size))
